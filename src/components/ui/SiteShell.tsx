...
export function SiteShell({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {/* Bottom sticky ads */}
      <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center items-center gap-4 py-2 backdrop-blur-sm border-t" style={{ backgroundColor: 'color-mix(in srgb, var(--surface-900) 95%, transparent)', borderColor: 'var(--border-color)' }}>
